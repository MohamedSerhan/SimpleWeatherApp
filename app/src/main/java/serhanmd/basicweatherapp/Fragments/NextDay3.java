...
public class NextDay3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.d(TAG,"NextDay3 Started."); //CHANGE THIS
        ...
        Log.d(TAG,"NextDay3: Found all views."); //CHANGE THIS

        setDataToViews(22); //Change THIS
